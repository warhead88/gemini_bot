...
from src.sessions.utils.config import get_gemini_api_key
...
async def send_message(user_id: int, text: str) -> str:
    ...
    try:
        response = await chat.send_message(text + """\n\nОтвечай на русском языке в формате HTML (только такие теги:
<b>, <strong>
<i>, <em>
<u>, <ins>
<s>, <strike>
...
<code>
<pre>
<blockquote>), без сплошного текста, дели текст на абзацы без тегов.""")
